...
const ModalSurveyMonth = ({ modalSurveyMonth, setModalSurveyMonth, modalWinMonth, setModalWinMonth, totalMoney, setTotalMoney, setWinnings, modalSurvey2, setModalSurvey2, winnings, user }) => {
...
export default ModalSurveyMonth
