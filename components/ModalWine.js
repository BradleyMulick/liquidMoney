...
const ModalWine = ({ modalWine, setModalWine, fluidName, setFluidName, convertOn, liquidType, setLiquidType, fluidLevel, setFluidLevel, handleAddTodoWine, allLogs, increase, decrease }) => {
