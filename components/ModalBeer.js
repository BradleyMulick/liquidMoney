...
const ModalBeer = ({ modalBeer, setModalBeer, fluidName, setFluidName, liquidType, setLiquidType, fluidLevel, setFluidLevel, handleAddTodoBeer, allLogs, increase, decrease }) => {
