...
const ModalBeer = ({ modalBeer, setModalBeer, convertOn, fluidName, setFluidName, liquidType, setLiquidType, fluidLevel, setFluidLevel, handleAddTodoBeer, allLogs, increase, decrease }) => {
        ...
        >
            <View style={styles.modalView}>
                ...
                <View style={styles.liquidAdd}>
                    <TouchableHighlight onPress={() => setNewFluidName('Beer', 236)} underlayColor="white">
                    ...
                    <TouchableHighlight onPress={() => setNewFluidName('Beer', 473)} underlayColor="white">
                        <View style={styles.row} >
                    ...
                    <TouchableHighlight onPress={() => setNewFluidName('Beer', 710)} underlayColor="white">
                        <View style={styles.row} >
                ...
                <View style={styles.confirm2}>
                    ...
                    {/* <TextInput
                        ...
                        onSubmitEditing={() => handleAddTodoBeer(allLogs)}
                ...
                <View style={styles.confirm}>
                    <Pressable
                        ...
                        onPress={() => handleAddTodoBeer(allLogs)}
                    >
