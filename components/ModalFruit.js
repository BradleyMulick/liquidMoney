...
const ModalFruit = ({ modalFruit, setModalFruit, fluidName, setFluidName, liquidType, setLiquidType, fluidLevel, setFluidLevel, handleAddTodoFruit, allLogs, increase, decrease }) => {
        ...
        >
            <View style={styles.modalView}>
                ...
                <View style={styles.liquidAdd}>
                    <TouchableHighlight onPress={() => setNewFluidName('Fruit', 59)} underlayColor="white">
                    ...
                    <TouchableHighlight onPress={() => setNewFluidName('Fruit', 118)} underlayColor="white">
                        <View style={styles.row} >
                            <MatCom name="fruit-watermelon" size={50} color="#4facfe" />
                            <Text>Medium</Text>
                        </View>
                    </TouchableHighlight>
                    <TouchableHighlight onPress={() => setNewFluidName('Fruit', 236)} underlayColor="white">
                        <View style={styles.row} >
                            <MatCom name="fruit-watermelon" size={50} color="#4facfe" />
                            <Text>Large</Text>
                        </View>
                ...
                <View style={styles.confirm2}>
                    ...
                    <TextInput
                        ...
                        onSubmitEditing={() => handleAddTodoFruit(allLogs)}
                ...
                <View style={styles.confirm}>
                    <Pressable
                        ...
                        onPress={() => handleAddTodoFruit(allLogs)}
                    >
