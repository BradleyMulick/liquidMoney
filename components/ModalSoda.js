...
const ModalSoda = ({ modalSoda, setModalSoda, setFluidName, convertOn, liquidType, setLiquidType, fluidLevel, setFluidLevel, handleAddTodoSoda, allLogs, increase, decrease, fluidName }) => {
