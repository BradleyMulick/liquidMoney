...
const ModalRando = ({ modalRando, setModalRando, fluidName, setFluidName, liquidType, setLiquidType, fluidLevel, setFluidLevel, handleAddTodoRando, allLogs, increase, decrease }) => {
            ...
            <View style={styles.modalView}>
                ...
                <View style={styles.confirm2}>
                    ...
                    <TextInput
                        ...
                        onSubmitEditing={() => handleAddTodoRando(allLogs)}
