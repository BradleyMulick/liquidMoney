...
const ModalIceCream = ({ modalIceCream, setModalIceCream, convertOn, fluidName, setFluidName, liquidType, setLiquidType, fluidLevel, setFluidLevel, handleAddTodoIceCream, allLogs, increase, decrease }) => {
