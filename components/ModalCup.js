...
const ModalCup = ({ modalCup, setModalCup, fluidName, convertOn, setFluidName, liquidType, setLiquidType, fluidLevel, setFluidLevel, handleAddTodoCup, allLogs, increase, decrease }) => {
